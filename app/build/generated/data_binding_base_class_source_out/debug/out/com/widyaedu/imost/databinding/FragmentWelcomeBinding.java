...
public final class FragmentWelcomeBinding implements ViewBinding {
  ...
  private FragmentWelcomeBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivImage,
      @NonNull TextView tvDeskripsi, @NonNull TextView tvTitle) {
  ...
  public static FragmentWelcomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvDeskripsi;
      TextView tvDeskripsi = rootView.findViewById(id);
      if (tvDeskripsi == null) {
        break missingId;
      }
      ...
      return new FragmentWelcomeBinding((LinearLayout) rootView, ivImage, tvDeskripsi, tvTitle);
    }
