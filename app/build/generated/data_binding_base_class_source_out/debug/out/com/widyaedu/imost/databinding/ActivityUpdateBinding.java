...
public final class ActivityUpdateBinding implements ViewBinding {
  ...
  @NonNull
  public final Button updateid;

  private ActivityUpdateBinding(@NonNull LinearLayout rootView, @NonNull Button updateid) {
  ...
  public static ActivityUpdateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.updateid;
      Button updateid = rootView.findViewById(id);
      if (updateid == null) {
        break missingId;
      }

      return new ActivityUpdateBinding((LinearLayout) rootView, updateid);
    }
