...
public final class ItemChatBinding implements ViewBinding {
  ...
  private ItemChatBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivImg,
  ...
  public static ItemChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatBinding((ConstraintLayout) rootView, ivImg, tvChat, tvDate);
    }
